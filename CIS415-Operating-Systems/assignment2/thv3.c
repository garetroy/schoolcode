/*
	Garett Roberts
	groberts
	This is my own work except for the implementation of the RR scheduler, which a huge mix of myself, Randy Chen, Howard Lin, and Chris Brooks.
	(Except for previously mentioned help on thv's)
*/
#include <stdlib.h>
#include <sys/time.h>
#include <time.h>
