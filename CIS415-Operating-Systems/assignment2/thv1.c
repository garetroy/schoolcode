/*
	Garett Roberts
	groberts
	This is my work, but conferred with Jack Brockway on implementation of parsing information
*/
...
main(int argc, char *argv[])
{
	...
	if(argc <= 1){
			errbuff = "usage: ./thv1 [--number=<nprocesses>] [--proccessors=<nproccessors>] --command='command'\n"; 
			p1putstr(2, errbuff);
			_exit(EXIT_FAILURE);
	}	
